 ...
 * @author Rob Winch
 */
public class CustomDaoAuthentication extends AbstractUserDetailsAuthenticationProvider {
    ...
    public CustomDaoAuthentication() {
    ...
    protected void additionalAuthenticationChecks(UserDetails userDetails,
        ...
        List<LockedUser> lockedUsers = lRepo.getLocked();

        for (LockedUser user : lockedUsers) {
