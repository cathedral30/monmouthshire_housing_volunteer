...
import com.nsa.mhasite.domain.EmailChangeForm;
...
public class AdminUserChangeController {
    ...
    @Autowired
    public AdminUserChangeController(UserRepository uRepo, VolunteerRepositoryJdbc vRepo, AddressRepositoryJdbc aRepo, ChangeEmailService cEmail, RegistrationFormCheck regCheck, UserRepositoryJdbc urRepo) {
