...
public class ChangeDetailsController {
    ...
    @Autowired
    public ChangeDetailsController(ChangeEmailService changeES, ChangePasswordService changePS, ChangePhoneService changePhS, VolunteerRepositoryJdbc vRepo, UserRepository uRepo) {
            ...
            if (emailChangeForm.getEmail().equals(emailChangeForm.getEmail2())) {
                try {
                    ...
                    if (rowsChanged == 1) {
                        ...
                        userDetails.setName(emailChangeForm.getEmail());
                        return returnDetailsPage(model);
                    } else {
